...
//Execute the query
$query = "Select Customer.c_name,Category.cat_name,COUNT(Category.cat_id) AS 'COUNTOFCATID',SUM(Product.price) AS 'AMOUNTTOBEPAID' FROM $select,Category,Product WHERE Category.p_id = Product.p_id GROUP BY c_name HAVING SUM(Product.price)>2.00";
